...
.then((response) => {
    ...
    data.projectdata.forEach((project, id) => {
        ...
        <div class="project-container flex flex-col xl:flex-row items-center align-center justify-center xl:my-20 xl:mx-20 my-5 mx-5 xl:gap-10 xl:p-10 p-5 max-h-1175 items-stretch">
            <div class="xl:w-1/2 w-full justify-center min-h-350 xl:max-w-700"><img class="mx-auto shadow-2xl" src="${project.image}" alt="${project.name} project image"></div>
            <div id="proj-desc${id}" class="xl:w-1/2 w-full max-w-700 xl:max-w-1200 proj-desc content-center text-wrap xl:pt-20 xl:pb-10 py-10">
